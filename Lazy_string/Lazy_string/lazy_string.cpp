...
//-------------------------------------------------------------
lazy_string::lazy_string(const char* str_ch)
	: my_size(std::strlen(str_ch) + 1)
	, l_string(new char[my_size])
{
...
//-------------------------------------------------------------
//move constructor
lazy_string::lazy_string(lazy_string&& move_str) noexcept
	: my_size(0)
	, l_string(nullptr)
{
	my_size = move_str.my_size;
	l_string = move_str.l_string;
	move_str.my_size = 0;
	move_str.l_string = nullptr;
}

//-------------------------------------------------------------
//move assignment operator
lazy_string& lazy_string::operator=(lazy_string&& other)
{
	if (this != &other) {
		delete[] l_string;
		my_size = 0;
		my_size = other.my_size;
		l_string = other.l_string;
		other.my_size = 0;
		other.l_string = nullptr;
	}
	return *this;
}
